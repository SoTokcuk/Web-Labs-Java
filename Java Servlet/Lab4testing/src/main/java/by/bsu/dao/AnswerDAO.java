...
public class AnswerDAO {
    ...
    public static List<Answer> getAnswers() {
        ...
        try {
            ...
            TypedQuery<Answer> testTypedQuery = entityManager.createNamedQuery("GET_ANSWERS", Answer.class);
            logger.info("Bringing up the answers list");
            return testTypedQuery.getResultList();
        } catch (Error e) {
            logger.error("Error getting answers list: " + e);
        } finally {
